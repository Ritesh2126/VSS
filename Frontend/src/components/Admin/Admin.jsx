...
function Admin() {
  ...
  useEffect(() => {
    ...
    const fetchuserData=()=>{
      ...
      const fetchprofileappData=()=>{
        axios
          .get("/api/users/getallrecomdprofile")
          .then((response) => {
            if (response.data.success) {
        ...
        const fetchprofilenotappData=()=>{
          axios
            .get("/api/users/getallnotapprovedprofile")
            .then((response) => {
              if (response.data.success) {
  ...
  function deleteuser(e){
    axios
        .post(`/api/users/deleteuserbyadmin/${e}`)
        .then((response) => {
          if (response.data.success) {
  ...
  function approveprodetails(e){
    axios
        .post(`/api/users/approvedprobyadmin/${e}`)
        .then((response) => {
          if (response.data.success) {
            window.location.href = `/adminDashboard`; 
...
window.location.href=`/profilecheck?data=${e}`
  ...
  function deleteprodetails(e){
    axios
        .post(`/api/users/deleteprobyadmin/${e}`)
        .then((response) => {
          if (response.data.success) {
            window.location.href = `/adminDashboard`; 
